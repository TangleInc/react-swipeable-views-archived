...
class SwipeableViews extends Component {
  ...
  setIndexCurrent(indexCurrent) {
    ...
    if (this.containerNode) {
      ...
      const transform = axisProperties.transform[axis](indexCurrent * this.slideWidthPercent);
...
So animateHeight is most likely having no effect at all.`,
    ...
    if (disableLazyLoading || !isFirstRender) {
      const transform = axisProperties.transform[axis](this.indexCurrent * this.slideWidthPercent);
