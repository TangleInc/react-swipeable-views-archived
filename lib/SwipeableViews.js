...
var SwipeableViews = function (_Component) {
  ...
  function SwipeableViews(props, context) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (SwipeableViews.__proto__ || (0, _getPrototypeOf2.default)(SwipeableViews)).call(this, props, context));
    ...
    _this.handleSwipeStart = function (event) {
      ...
      if (_this.slideWidthPercent) {
        _this.viewLength = _this.viewLength * _this.slideWidthPercent / 100;
      }
  ...
  (0, _createClass3.default)(SwipeableViews, [{
    ...
    value: function setIndexCurrent(indexCurrent) {
      ...
      if (this.containerNode) {
        ...
        var transform = axisProperties.transform[axis](indexCurrent * this.slideWidthPercent);
    ...
    value: function render() {
      ...
      if (disableLazyLoading || !isFirstRender) {
        var transform = axisProperties.transform[axis](this.indexCurrent * this.slideWidthPercent);
